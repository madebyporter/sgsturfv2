...
if ( ! class_exists( 'Addify_Request_For_Quote' ) ) {
	...
	class Addify_Request_For_Quote {
		...
		public function __construct() {
			...
			//HOPS compatibility
			add_action('before_woocommerce_init', array($this, 'afrfq_HOPS_Compatibility'));
		}


		public function afrfq_HOPS_Compatibility() {
		...
		public function load_rest_api() {
			require AFRFQ_PLUGIN_DIR . 'includes/rest-api/Server.php';
