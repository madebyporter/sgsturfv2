...
$orderNote = esc_html__('This order has been created from ', 'addify_rfq') . '<a href="post.php?post=' . $post->ID . '&action=edit">quote # ' . $post->ID . '</a>';

// Add the note
$quote_order->add_order_note( $orderNote );
