...
ESSBOptionsStructureHelper::panel_start('advanced', 'advanced', esc_html__('Compatibility with previous versions', 'essb'), '', 'fa21 fa fa-cogs', array("mode" => "toggle", 'state' => 'closed', 'css_class' => 'essb-auto-open'));
ESSBOptionsStructureHelper::hint('advanced', 'advanced', '', esc_html__('The options below provide a backward compatibility with previous plugin functions that were updated. All migrations are done automatically. In case of a problem you can enable the related option below.', 'essb'), '', 'glowhint');
ESSBOptionsStructureHelper::field_switch('advanced', 'advanced', 'legacy_shorturl_cache', esc_html__('Short URLs stored in the post meta', 'essb'), esc_html__('Use the previously stored short URLs in the post meta table.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'advanced', 'legacy_icon_font', esc_html__('Load previously used icon font before migration to SVG icons', 'essb'), '', '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
